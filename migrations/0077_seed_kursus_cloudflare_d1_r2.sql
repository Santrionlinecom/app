...
INSERT OR REPLACE INTO kursus (id, slug, judul, ringkasan, deskripsi, harga_koin, level, kategori, sampul_url, durasi_menit, status, urutan, created_at, updated_at) VALUES ('kursus-cloudflare-d1-r2', 'bangun-deploy-aplikasi-edge-1-hari', 'Bangun & Deploy Aplikasi Edge dalam 1 Hari', 'Cloudflare D1 + R2, WSL, Wrangler, dan GitHub — sampai kelola website cukup dari Telegram. Termasuk slide PPT resmi.', 'Kursus 1 dari 2. Tujuh modul dari kamus istilah sampai commit-push-deploy, plus studi kasus form + unggah berkas.', 0, 'dasar', 'Teknologi & Platform', NULL, 135, 'published', 5, 1787011076550, 1787011076550);

INSERT OR REPLACE INTO kursus_materi (id, kursus_id, judul, isi, urutan, durasi_menit, created_at, updated_at) VALUES ('kursus-cloudflare-d1-r2-m1', 'kursus-cloudflare-d1-r2', 'Pengantar — apa yang Anda miliki di akhir kursus', 'Ini **Kursus 1 dari 2**. Tujuh modul, studi kasus nyata, dari nol sampai aplikasi **LIVE**.
...
[Unduh PPT: Kursus 1 — Cloudflare D1 + R2](https://files.santrionline.com/kursus/cloudflare-d1-r2/Kursus-1-Cloudflare-D1-R2.pptx)
...
', 1, 22, 1787011076550, 1787011076550);
INSERT OR REPLACE INTO kursus_materi (id, kursus_id, judul, isi, urutan, durasi_menit, created_at, updated_at) VALUES ('kursus-cloudflare-d1-r2-m2', 'kursus-cloudflare-d1-r2', 'Kamus istilah — Cloudflare, D1, R2, GitHub', 'Tanpa kamus ini, perintah di terminal terasa seperti bahasa asing. Baca sekali, lalu pakai sebagai rujukan.
...
', 2, 22, 1787011076550, 1787011076550);
INSERT OR REPLACE INTO kursus_materi (id, kursus_id, judul, isi, urutan, durasi_menit, created_at, updated_at) VALUES ('kursus-cloudflare-d1-r2-m3', 'kursus-cloudflare-d1-r2', 'Modul 1–2 — kenapa serverless, lalu siapkan WSL', '## Modul 1 — VPS vs Cloudflare
...
', 3, 22, 1787011076550, 1787011076550);
INSERT OR REPLACE INTO kursus_materi (id, kursus_id, judul, isi, urutan, durasi_menit, created_at, updated_at) VALUES ('kursus-cloudflare-d1-r2-m4', 'kursus-cloudflare-d1-r2', 'Modul 3–4 — Wrangler, D1, R2, dan API Token', '## Modul 3 — tiga perintah pertama
...
', 4, 22, 1787011076550, 1787011076550);
INSERT OR REPLACE INTO kursus_materi (id, kursus_id, judul, isi, urutan, durasi_menit, created_at, updated_at) VALUES ('kursus-cloudflare-d1-r2-m5', 'kursus-cloudflare-d1-r2', 'Modul 5–6 — form + R2, lalu website dari Telegram', '## Modul 5 — studi kasus aplikasi
...
', 5, 22, 1787011076550, 1787011076550);
INSERT OR REPLACE INTO kursus_materi (id, kursus_id, judul, isi, urutan, durasi_menit, created_at, updated_at) VALUES ('kursus-cloudflare-d1-r2-m6', 'kursus-cloudflare-d1-r2', 'Modul 7 — commit, push, deploy, plus unduh slide', '## Alur yang dibawa pulang
...
[Unduh PPT resmi Kursus 1](https://files.santrionline.com/kursus/cloudflare-d1-r2/Kursus-1-Cloudflare-D1-R2.pptx)
...
', 6, 22, 1787011076550, 1787011076550);
