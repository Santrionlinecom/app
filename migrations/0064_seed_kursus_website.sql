...
INSERT OR REPLACE INTO kursus (id, slug, judul, ringkasan, deskripsi, harga_koin, level, kategori, sampul_url, durasi_menit, status, urutan, created_at, updated_at) VALUES ('kursus-bangun-website', 'membangun-website-sendiri', 'Membangun Website Sendiri: Dari Istilah Dasar sampai Menghasilkan', 'Kurikulum lengkap untuk pemula yang ingin punya platform sendiri: istilah dasar, Cloudflare, GitHub, dashboard superadmin, dan monetisasi.', 'Disusun dari pertanyaan nyata seorang pemula yang ingin membangun platformnya sendiri. Tidak mengandaikan latar belakang teknis apa pun.', 0, 'dasar', 'Teknologi & Platform', NULL, 180, 'published', 4, 1786943726925, 1786943726925);

INSERT OR REPLACE INTO kursus_materi (id, kursus_id, judul, isi, urutan, durasi_menit, created_at, updated_at) VALUES ('kursus-bangun-website-m1', 'kursus-bangun-website', 'Tahap 1 — Istilah dasar yang wajib dipahami', 'Sebelum menyentuh alat apa pun, tujuh istilah ini perlu jelas dahulu. Tanpa ini, semua tahap berikutnya terasa seperti bahasa asing.
...
Yang penting: **subdomain tidak perlu dibeli lagi.** Satu domain bisa punya ratusan subdomain tanpa biaya domain tambahan.', 1, 30, 1786943726925, 1786943726925);
INSERT OR REPLACE INTO kursus_materi (id, kursus_id, judul, isi, urutan, durasi_menit, created_at, updated_at) VALUES ('kursus-bangun-website-m2', 'kursus-bangun-website', 'Tahap 2 — Cloudflare: rumah bagi website Anda', 'Seluruh website bisa berjalan di Cloudflare tanpa menyewa server sendiri. Ini menjelaskan caranya.
...
Yang paling sering Anda pakai: **CNAME** untuk subdomain, dan **TXT** ketika memasang layanan pengirim email.', 2, 30, 1786943726925, 1786943726925);
INSERT OR REPLACE INTO kursus_materi (id, kursus_id, judul, isi, urutan, durasi_menit, created_at, updated_at) VALUES ('kursus-bangun-website-m3', 'kursus-bangun-website', 'Tahap 3 — GitHub: menyimpan dan menerbitkan kode', 'GitHub sering membingungkan pemula karena istilahnya terdengar teknis. Padahal idenya sederhana.
...
Aturan praktis: apa pun yang masuk ke `main` akan langsung tayang. Karena itu percobaan sebaiknya dilakukan di branch lain dahulu.', 3, 30, 1786943726925, 1786943726925);
INSERT OR REPLACE INTO kursus_materi (id, kursus_id, judul, isi, urutan, durasi_menit, created_at, updated_at) VALUES ('kursus-bangun-website-m4', 'kursus-bangun-website', 'Tahap 4 — Dashboard dan superadmin', 'Ini bagian yang paling sering Anda pakai sehari-hari sebagai pemilik platform.
...
Setelah tampilan jadi, lanjutkan dengan sidebar dan dashboard, baru sambungkan ke Cloudflare.', 4, 30, 1786943726925, 1786943726925);
INSERT OR REPLACE INTO kursus_materi (id, kursus_id, judul, isi, urutan, durasi_menit, created_at, updated_at) VALUES ('kursus-bangun-website-m5', 'kursus-bangun-website', 'Tahap 5 — Monetisasi: dari pengunjung menjadi pemasukan', 'Website yang bagus tanpa cara menerima uang hanyalah biaya. Ini menutup rantainya.
...
Namun perlu jujur: membangun kesembilan langkah ini butuh waktu. Jangan mengerjakan semuanya sekaligus. Mulailah dari pendaftaran dan satu produk, pastikan berjalan, baru lanjutkan.', 5, 30, 1786943726925, 1786943726925);
INSERT OR REPLACE INTO kursus_materi (id, kursus_id, judul, isi, urutan, durasi_menit, created_at, updated_at) VALUES ('kursus-bangun-website-m6', 'kursus-bangun-website', 'Bonus — Peluang yang belum digarap orang lain', 'Bagian ini bukan materi dasar, melainkan peluang nyata yang layak dipertimbangkan.
...
Mulailah dari satu halaman. Terbitkan. Lihat hasilnya di internet. Perasaan itu — melihat karya sendiri bisa dibuka siapa saja — adalah bahan bakar untuk langkah berikutnya.', 6, 30, 1786943726925, 1786943726925);
