...
INSERT OR REPLACE INTO kursus (id, slug, judul, ringkasan, deskripsi, harga_koin, level, kategori, sampul_url, durasi_menit, status, urutan, created_at, updated_at) VALUES ('kursus-peta-santrionline', 'peta-lengkap-santrionline', 'Peta Lengkap SantriOnline: Dari Nol sampai Menghasilkan', 'Satu kursus yang menerangkan seluruh isi platform — lembaga, buku, produk digital, kursus, dan koin — beserta cara kerjanya.', 'Satu kursus yang menerangkan seluruh isi platform — lembaga, buku, produk digital, kursus, dan koin — beserta cara kerjanya.', 0, 'dasar', 'Panduan Platform', NULL, 75, 'published', 1, 1786941792248, 1786941792248);
INSERT OR REPLACE INTO kursus_materi (id, kursus_id, judul, isi, urutan, durasi_menit, created_at, updated_at) VALUES ('kursus-peta-santrionline-m1', 'kursus-peta-santrionline', 'Apa itu SantriOnline dan untuk siapa', 'SantriOnline bukan sekadar tempat belajar agama, dan bukan pula sekadar toko digital.
...
Kursus ini menerangkan semuanya, satu per satu.', 1, 12, 1786941792248, 1786941792248);
INSERT OR REPLACE INTO kursus_materi (id, kursus_id, judul, isi, urutan, durasi_menit, created_at, updated_at) VALUES ('kursus-peta-santrionline-m2', 'kursus-peta-santrionline', 'Koin: satu dompet untuk semua', 'Koin adalah alat bayar di seluruh SantriOnline. Satu dompet, dipakai untuk apa saja.
...
Saldo koin tersimpan di akun Anda dan tidak hangus. Setiap pemakaian tercatat lengkap dengan keterangan dan waktunya.', 2, 12, 1786941792248, 1786941792248);
INSERT OR REPLACE INTO kursus_materi (id, kursus_id, judul, isi, urutan, durasi_menit, created_at, updated_at) VALUES ('kursus-peta-santrionline-m3', 'kursus-peta-santrionline', 'Lembaga: mengelola TPQ, masjid, dan pondok', 'Bagian ini untuk pengurus lembaga.
...
Pakai yang pertama untuk anak-anak.', 3, 12, 1786941792248, 1786941792248);
INSERT OR REPLACE INTO kursus_materi (id, kursus_id, judul, isi, urutan, durasi_menit, created_at, updated_at) VALUES ('kursus-peta-santrionline-m4', 'kursus-peta-santrionline', 'Buku: menulis, menerbitkan, bagi hasil', 'Siapa pun bisa menulis dan menerbitkan buku di SantriOnline.
...
Anda cukup menulis.', 4, 12, 1786941792248, 1786941792248);
INSERT OR REPLACE INTO kursus_materi (id, kursus_id, judul, isi, urutan, durasi_menit, created_at, updated_at) VALUES ('kursus-peta-santrionline-m5', 'kursus-peta-santrionline', 'Produk digital dan kursus', '**Produk digital**
...
Untuk mengajarkan keterampilan bertahap, kursus lebih tepat.', 5, 12, 1786941792248, 1786941792248);
INSERT OR REPLACE INTO kursus_materi (id, kursus_id, judul, isi, urutan, durasi_menit, created_at, updated_at) VALUES ('kursus-peta-santrionline-m6', 'kursus-peta-santrionline', 'Cara memulai hari ini', 'Jangan mencoba semuanya sekaligus. Pilih satu sesuai kebutuhan Anda.
...
Selamat mencoba.', 6, 12, 1786941792248, 1786941792248);

INSERT OR REPLACE INTO kursus (id, slug, judul, ringkasan, deskripsi, harga_koin, level, kategori, sampul_url, durasi_menit, status, urutan, created_at, updated_at) VALUES ('kursus-adab-digital', 'adab-santri-di-dunia-digital', 'Adab Santri di Dunia Digital', 'Menjaga lisan, mata, dan waktu ketika sebagian besar hidup berpindah ke layar.', 'Menjaga lisan, mata, dan waktu ketika sebagian besar hidup berpindah ke layar.', 0, 'dasar', 'Adab & Akhlak', NULL, 45, 'published', 2, 1786941792248, 1786941792248);
INSERT OR REPLACE INTO kursus_materi (id, kursus_id, judul, isi, urutan, durasi_menit, created_at, updated_at) VALUES ('kursus-adab-digital-m1', 'kursus-adab-digital', 'Layar juga majelis', 'Para ulama dahulu sangat menjaga adab ketika masuk majelis ilmu: duduk rapi, diam, mendengar.
...
Bila ustadz Anda berdiri di belakang Anda sekarang dan melihat layar HP Anda — apakah Anda akan tenang?', 1, 15, 1786941792248, 1786941792248);
INSERT OR REPLACE INTO kursus_materi (id, kursus_id, judul, isi, urutan, durasi_menit, created_at, updated_at) VALUES ('kursus-adab-digital-m2', 'kursus-adab-digital', 'Menjaga lisan yang berbentuk ketikan', 'Rasulullah ﷺ bersabda:
...
Bila salah satu tidak lolos, jangan kirim.', 2, 15, 1786941792248, 1786941792248);
INSERT OR REPLACE INTO kursus_materi (id, kursus_id, judul, isi, urutan, durasi_menit, created_at, updated_at) VALUES ('kursus-adab-digital-m3', 'kursus-adab-digital', 'Waktu adalah modal yang tidak kembali', 'Allah bersumpah dengan waktu:
...
Pembahasan disusun bertahap, dengan bahasa yang bisa dipahami tanpa latar belakang pesantren.', 1, 40, 1786941792248, 1786941792248);
INSERT OR REPLACE INTO kursus_materi (id, kursus_id, judul, isi, urutan, durasi_menit, created_at, updated_at) VALUES ('kursus-fondasi-aqidah-m2', 'kursus-fondasi-aqidah', 'Mengenal Allah lewat sifat-sifat-Nya', 'Ahlus Sunnah mengenal Allah melalui sifat-sifat yang Dia kabarkan sendiri dalam Al-Qur''an dan lewat lisan Rasul-Nya.
...
Enam ini menjadi pintu masuk sebelum membahas sifat-sifat berikutnya.', 2, 40, 1786941792248, 1786941792248);
INSERT OR REPLACE INTO kursus_materi (id, kursus_id, judul, isi, urutan, durasi_menit, created_at, updated_at) VALUES ('kursus-fondasi-aqidah-m3', 'kursus-fondasi-aqidah', 'Cinta kepada Rasulullah ﷺ', 'Aqidah bukan hanya urusan akal. Ia juga urusan hati.
...
Bukan hanya bershalawat di lisan, tetapi meneladani akhlaknya dalam kehidupan sehari-hari — di rumah, di tempat kerja, dan di layar HP kita.', 3, 40, 1786941792248, 1786941792248);
