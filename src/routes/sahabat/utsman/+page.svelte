...
<section class="max-w-4xl mx-auto space-y-6 py-10">
	...
	<div class="space-y-3 text-slate-700">
		<p>Menstandarkan Mushaf Utsmani dan menyebarkannya ke berbagai wilayah untuk menjaga kesatuan bacaan.</p>
		<p>Mendorong dakwah maritim dan perdagangan ke Afrika Utara serta wilayah baru umat Islam.</p>
	</div>
</section>
