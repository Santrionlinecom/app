...
<div class="container mx-auto p-4 max-w-4xl">
  ...
  <form method="POST" use:enhance class="space-y-4">
    <div class="form-control">
      ...
      <input type="text" id="title" name="title" bind:value={title} oninput={generateSlug} class="input input-bordered" required />
    </div>
    ...
    <div class="form-control">
      ...
      <textarea id="content" name="content" class="textarea textarea-bordered" rows="15" required></textarea>
    </div>
