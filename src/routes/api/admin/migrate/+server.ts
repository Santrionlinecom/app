...
import { ensureHafalanTable, ensureHafalanSurahChecksTable } from '$lib/server/domains/tpq/hafalan';
...
import { ensureDigitalCommerceSchema } from '$lib/server/domains/digital-store/commerce';
...
import { ensureStreamerLicenseTables } from '$lib/server/domains/digital-store/license/streamer-db';
...
import { ensureDrmSchema } from '$lib/server/domains/buku/drm';
import { ensureHafalanRaporSchema } from '$lib/server/domains/tpq/db-hafalan';
