...
<div class="super-admin-shell relative space-y-10 pb-16">
	...
	<!-- Digital commerce sections moved to /admin/super/cms-hub -->
	<section class="reveal rounded-[2rem] border border-white/80 bg-white/85 p-6 shadow-lg backdrop-blur" style="animation-delay: 170ms;">
		<div class="flex flex-col gap-4 lg:flex-row lg:items-center lg:justify-between">
			<div class="max-w-2xl">
