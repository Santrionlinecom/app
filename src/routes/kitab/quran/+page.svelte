...
<section class="mx-auto w-full min-w-0 max-w-7xl space-y-6 overflow-x-clip px-3 py-6 sm:px-4 sm:py-10">
	...
	{#if activeTab === 'mushaf'}
		<div class="min-w-0 space-y-4 overflow-hidden rounded-2xl border bg-base-100 p-2.5 shadow-sm sm:p-4 md:p-6">
