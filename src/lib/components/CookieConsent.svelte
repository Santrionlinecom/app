		...
		<div class="mx-auto max-w-3xl overflow-hidden rounded-xl border border-emerald-200/80 bg-white shadow-[0_16px_42px_rgba(15,23,42,0.16)] sm:max-w-none">
			<div class="grid gap-3 p-3 sm:p-4">
				<div class="space-y-2.5">
					...
					{#if showPreferences}
						<div class="grid gap-2.5 rounded-xl border border-slate-200 bg-slate-50 p-3">
							...
							<label class="flex cursor-pointer items-start justify-between gap-3">
								<div>
									<p class="text-xs font-semibold text-slate-900">Analytics</p>
									<p class="mt-1 text-[11px] leading-4 text-slate-600">Membantu kami melihat statistik kunjungan, heatmap, dan rekaman sesi untuk perbaikan pengalaman.</p>
								</div>
