...
-- Referensi kitab untuk pencarian AI dan import OpenITI
...
-- SantriLearn staged learning paths
...
VALUES
  ...
  ('learn-nahwu-level-01', NULL, 'arabic_nahwu', 'Ajza''ul Jumlah - 3 Jenis Kata Arab', 'Mengenal Isim, Fi''il, dan Harf sebagai bagian dasar kalimat Arab.', 'nahwu', 1, 1);
...
VALUES
  ...
  ('learn-l01-q02', 'learn-nahwu-level-01', 'pilihan_ganda', 'كَتَبَ termasuk?', '["Isim","Fi''il","Harf","Dhamir"]', 'Isim', 'Fi''il', 'Harf', 'Dhamir', 'b', 'كَتَبَ menunjukkan perbuatan pada masa lampau, maka termasuk fi''il.', 2),
  ('learn-l01-q03', 'learn-nahwu-level-01', 'pilihan_ganda', 'فِي termasuk?', '["Isim","Fi''il","Harf","Khabar"]', 'Isim', 'Fi''il', 'Harf', 'Khabar', 'c', 'فِي adalah kata tugas atau huruf jar, maka termasuk harf.', 3);
